...
namespace FinalQuizProgram.Controllers
{
    public class StudentManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Correct,Attempts")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Correct,Attempts")] Student student)
        {
            if (ModelState.IsValid)
            {
